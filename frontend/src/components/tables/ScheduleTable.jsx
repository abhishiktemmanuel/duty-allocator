...
const ScheduleTable = () => {
  ...
  const handleInputChange = (e, field) => {
    ...
    setEditingSchedule(prev => ({
      ...prev,
      [field]: field === 'subject' ? { ...prev.subject, name: value } : value
    }));
  };
          ...
          <form onSubmit={(e) => {
            ...
            <div>
              ...
              <input
                type="text"
                name="subject"
                value={editingSchedule.subject.name}
              ...
              <>
                <td className="py-4 px-6">
                  <input 
                    type="text"
                    value={editingSchedule.subject.name}
                    onChange={(e) => handleInputChange(e, 'subject', schedule)}
                ...
                <td className="py-4 px-6">
                  <input 
                    type="date"
                    value={format(new Date(editingSchedule.date), 'yyyy-MM-dd')}
                    onChange={(e) => handleInputChange(e, 'date', schedule)}
                ...
                <td className="py-4 px-6">
                  <select 
                    value={editingSchedule.shift}
                    onChange={(e) => handleInputChange(e, 'shift', schedule)}
                    className="border rounded px-2 py-1 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                  >
                    <option value="Morning">Morning</option>
                    <option value="Evening">Evening</option>
                ...
                <td className="py-4 px-6">
                  <input 
                    ...
                    onChange={(e) => handleInputChange(e, 'rooms', schedule)}
                    className="border rounded px-2 py-1 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                  />
                </td>
                <td className="py-4 px-6">
                  <input 
                    ...
                    onChange={(e) => handleInputChange(e, 'standard', schedule)}
                    className="border rounded px-2 py-1 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                  />
                </td>
                <td className="py-4 px-6">
