...
import { FiArrowLeft, FiLock, FiMail, FiUser, FiBook, FiAlertCircle, FiGlobe, FiLoader } from "react-icons/fi";
          ...
          <div className="space-y-5">
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-11 pr-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-sm text-gray-800 dark:text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-500/30 transition-all"
              />
            </div>
